    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">View all employees across teams</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        {teamStats.map((team) => (
          <Card key={team.name} className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-gray-100">
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-gray-600 text-xs font-medium truncate">{team.name}</p>
                <p className="text-xl font-bold text-gray-900">{team.count}</p>
              </div>
            </CardContent>
          </Card>
        ))}
            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Badge variant="outline" className={getTeamColor(employee.team)}>
                    {employee.team}
                  </Badge>
                </div>
